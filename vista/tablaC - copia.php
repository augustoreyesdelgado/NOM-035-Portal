...
<TABLE style="font-family:Helvetica; width: 900px;">
            
        <TR>
        <TD id="sit5" style="background-color: Gray">Acontecimiento traum&aacute;tico severo: <?php echo $arrayq1['r'];?> </TD>
        <?php if(empty($arrayq1['c'])){?>
        <TD COLSPAN=3 COLSPAN=3 id="sit" style="background-color: rgb(76, 102, 105)"><FONT SIZE=2><p>No se ha tomado este cuestionario.</p></FONT></TD>
        <?php } else if(empty($arrayq1['r']) && $arrayq1['r']<2){?>
        <TD COLSPAN=3 id="sit" style="background-color: #31ff31">No requiere atenci&oacute;n</TD>
        <?php }else { ?>
        <?php if($arrayq1['s1']>0){?>
        ...
        <?php }?>
        <?php } ?>
        <TD id="sit5" style="background-color: Gray">Panel de sugerencias </TD>
        </TR>
            
        <?php if($nivel['n']==3){ 
        $arrayq3=$object_usuario->evaluar3E($_POST["correo"]);
        $arrayq2=$object_usuario->evaluar2E($_POST["correo"]);
        ?>
        <TR>
        <TD id="sit5" style="background-color: Blue">Factores de riesgo psicosocial general: <?php echo $arrayq2['r'];?></TD>
